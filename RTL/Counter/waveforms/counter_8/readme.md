...
- ### 0: Power on and Reset
  ...
  ![Test 0: Power on and Reset](8-bit-test0.png)

- ### 1: Continuous Counting
  
  For this test, the counter kept counting from 0-255 with no interruption.
  ![Test 1](8-bit-test1.png)

  ![Test 0 Zoom](8-bit-test1-zoom.png)
...
- ### 2: Discontinuous counting
  ...
  ![Test 2 1](8-bit-test-2.png)
  ![Test 2 2](8-bit-test-2-reset.png)
